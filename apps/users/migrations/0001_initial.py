# Generated by Django 4.2.16 on 2026-05-28 07:52
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(
                        blank=True, max_length=50, null=True, verbose_name="角色编码"
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        blank=True, max_length=50, null=True, verbose_name="菜单名称"
                    ),
                ),
                (
                    "icon",
                ...
                (
                    "path",
                    models.CharField(
                        blank=True, max_length=200, null=True, verbose_name="路由地址"
                    ),
                ),
                (
                    "component",
                    models.CharField(
                        blank=True, max_length=200, null=True, verbose_name="前端组件"
                    ),
                ),
                (
                    "sort",
                ...
                (
                    "hidden",
                    models.BooleanField(
                        blank=True, default=False, null=True, verbose_name="是否隐藏"
                    ),
                ),
